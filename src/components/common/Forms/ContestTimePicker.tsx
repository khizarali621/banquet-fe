...
import { Calendar, Time } from "@/components/common/Icons";

interface ContestTimePickerProps {
  className?: string;
  selected?: Date;
...
const ContestTimePicker: React.FC<ContestTimePickerProps> = ({
  className,
  selected,
  onChange,
  ...props
  ...
  return (
    <div className="relative rounded-xl border border-[#D7DAE0] w-full">
      <DatePicker
        ...
        timeCaption="Time"
        dateFormat="h:mm aa" // Format for time picker
...
export default ContestTimePicker;
